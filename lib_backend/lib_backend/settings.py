"""
Django settings for back_basic project.
...
SECRET_KEY = 'django-insecure-r@1%iwh_i6keg2*d#48-e!p+_gysd3n019a93$tyudsms3)dnu'
...
WSGI_APPLICATION = 'lib_backend.wsgi.application'
